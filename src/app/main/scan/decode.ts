...
function processImage(rgbpixels) {
    rgbpixels = new Uint8ClampedArray(rgbpixels)
    ...
    for (var i = 0, ii: any = pixels.length; i < ii; i++) {
    ...
    for (var i = 0, ii: any = binary.length; i < ii; i++) {
        if (binary[i] == current) {
            count++;
        } else {
    ...
    for (var i = 3, ii: any = pixelBars.length; i < ii; i++) {
    ...
    for (var i = 0, ii: any = pixelBars.length; i < ii; i++) {
